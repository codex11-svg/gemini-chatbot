...
# -----------------------------
# == USER SETTINGS – DO NOT EDIT KEY HERE! ==
MODEL = "gemini-2.5-flash"
DAY_LIMIT = 25
WAIT_SECONDS = 12
# -----------------------------

# == Safest KEY: MUST use Streamlit Secrets ==
API_KEY = st.secrets["GEMINI_API_KEY"]  # Set this ONLY in Streamlit Cloud!
os.environ["GOOGLE_API_KEY"] = API_KEY
genai.configure(api_key=API_KEY)

# == Avatars (replace icons as desired) ==
...
st.markdown(
    ...
    f"<span class='technote'>AI chat &bull; API key always hidden &bull; Google Gemini free tier: 24/day</span></div>",
...
def play_notification_sound():
    ...
    # (This is a very small non-obnoxious chime. Replace with your own base64 wav if you wish!)
    audio_html = f"""
    <audio autoplay>
